    ...
    <UModal v-model:open="showModal">
      ...
      <template #content>
        <div v-if="openImageId" class="relative">
          ...
          <Icon name="tabler:x" class="absolute top-2 end-2 w-8 h-8 text-neutral-200 hover:text-neutral-300 bg-neutral-900/70 hover:bg-neutral-900 rounded p-1.5" @click="openImageId = null; showModal = false;" />
        </div>
      </template>
    </UModal>
  </main>
