    ...
    <div class="space-y-4 mb-5">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
        ...
        <div class="flex flex-col gap-2">
          <!-- WINRATE -->
          <div class="bg-neutral-950/85 border border-purple-300/40 rounded-lg p-2 sm:p-2 text-center flex flex-col items-center justify-center">
          ...
          <div class="flex items-center justify-center gap-2">
            ...
            <!-- DERROTAS -->
            <div class="bg-neutral-950/85 border border-rose-300/40 rounded-lg p-2 sm:p-2 text-center flex flex-col items-center justify-center w-full">
